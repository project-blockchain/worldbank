...
async function productTransfer(orgName, userName, secretKey, channelName, contractName, param) {
    ...
    try {
        ...
        console.log('Submit viewBalance transaction.');
        const response = await contract.submitTransaction("viewBalance", param[0], param[1]);
...
viewBalance("xbank", "User1", "82592ffb23cc9207d8023a51374c1f75e803fefd96d23faf301b18c62c9da779", "cbtchannel", "bacc105", ["hdfc", "1"]).then(() => {
    console.log('viewBalance program complete.');
    }).catch((e) => {
        console.log('viewBalance program exception.');
        console.log(e);
        console.log(e.stack);
        process.exit(-1);
    });
