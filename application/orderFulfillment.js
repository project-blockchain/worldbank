...
async function orderFulfillment(orgName, userName, secretKey, channelName, contractName, param) {
    ...
    try {
        ...
        const response = await contract.submitTransaction("orderFulfillment", param[0], param[1], param[2], param[3], param[4]);
