...
async function interBankFundTransfer(orgName, userName, secretKey, channelName, contractName, param) {
    ...
    try {
        ...
        console.log('Submit interBankFundTransfer transaction.');
        const response = await contract.submitTransaction("interBankFundTransfer", param[0], param[1], param[2], param[3], param[4]);
...
module.exports = interBankFundTransfer;
// driver Code

// interBankFundTransfer("xbank", "User1", "82592ffb23cc9207d8023a51374c1f75e803fefd96d23faf301b18c62c9da779", "cbtchannel", "bacc105", ["hdfc", "1", "xbank", "1", "100"]).then(() => {
//     console.log('interBankFundTransfer program complete.');
//     }).catch((e) => {
//         console.log('interBankFundTransfer program exception.');
//         console.log(e);
//         console.log(e.stack);
//         process.exit(-1);
//     });
